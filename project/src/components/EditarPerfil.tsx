...
export default function EditarPerfil() {
  ...
  return (
    <div className="relative">
      ...
      {sucesso && (
        <div className="fixed top-4 right-4 bg-emerald-50 text-emerald-600 px-6 py-3 rounded-lg shadow-lg border border-emerald-200 flex items-center gap-2 animate-slideIn z-50">
      ...
      {erro && (
        <div className="fixed top-4 right-4 bg-red-50 text-red-600 px-6 py-3 rounded-lg shadow-lg border border-red-200 flex items-center gap-2 animate-slideIn z-50">
